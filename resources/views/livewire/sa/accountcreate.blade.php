        ...
        <div class="bg-gray-800 px-4 py-1 sm:p-6 sm:pb-4">
          <div class="">
                <div class="mb-0">
                    ...
                    <input type="text" class="shadow appearance-none rounded w-full py-2 px-3 bg-gray-600 text-white leading-tight focus:outline-none focus:shadow-outline" placeholder="Cash in Hand" wire:model.lazy="name" x-ref="desc">
                </div>
          </div>
        </div>
        <div class="bg-gray-800 px-4 py-1 sm:p-6 sm:pb-4">
