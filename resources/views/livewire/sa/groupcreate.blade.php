        ...
        <div class="bg-gray-800 px-4 pt-2">
          <div class="">
                <div class="mb-0">
                    ...
                    <input type="text" class="shadow appearance-none rounded w-full py-2 px-3 bg-gray-600 text-white leading-tight focus:outline-none focus:shadow-outline" placeholder="Cash and Bank Balances" wire:model.lazy="name" x-ref="desc">
                </div>
          </div>
        </div>
        <div class="bg-gray-800 px-4 pb-2 pt-2">
          <div class="">
                <div class="mb-2">
                    ...
                    <select wire:model="type_id" class="shadow p-2 bg-gray-600 text-white rounded leading-tight focus:outline-none focus:shadow-outline">
