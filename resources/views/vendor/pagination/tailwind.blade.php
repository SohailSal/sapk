                ...
                <span class="relative z-0 inline-flex shadow-sm rounded-md">
                    ...
                    @if ($paginator->onFirstPage())
                        <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                            <span class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-500 bg-black border border-gray-300 cursor-default rounded-l-md leading-5" aria-hidden="true">
